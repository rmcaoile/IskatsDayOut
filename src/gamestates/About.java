...
public class About extends State implements Statemethods{
    ...
    public void draw(GraphicsContext gc) {
        ...
        double midpoint = (double) Game.GAME_WIDTH /2;

        Image aboutLeft = new Image("images/menu/aboutLeft.png", AL_WIDTH, AL_HEIGHT, false, false);
        gc.drawImage(aboutLeft, midpoint /6, 90);

        Image aboutRight = new Image("images/menu/aboutRight.png", AR_WIDTH, AR_HEIGHT, false, false);
        gc.drawImage(aboutRight, midpoint+50, 90);
    }
